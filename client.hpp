...
namespace C_BaseCSGrenade {
    constexpr std::ptrdiff_t m_bClientPredictDelete = 0x19F0;
    constexpr std::ptrdiff_t m_bRedraw = 0x19F1;
    constexpr std::ptrdiff_t m_bIsHeldByPlayer = 0x19F2;
    constexpr std::ptrdiff_t m_bPinPulled = 0x19F3;
    constexpr std::ptrdiff_t m_bJumpThrow = 0x19F4;
    constexpr std::ptrdiff_t m_eThrowStatus = 0x19F8;
    constexpr std::ptrdiff_t m_fThrowTime = 0x19FC;
    constexpr std::ptrdiff_t m_flThrowStrength = 0x1A00;
    constexpr std::ptrdiff_t m_flThrowStrengthApproach = 0x1A04;
    constexpr std::ptrdiff_t m_fDropTime = 0x1A08;
}
...
namespace C_C4 {
    constexpr std::ptrdiff_t m_szScreenText = 0x19F0;
    constexpr std::ptrdiff_t m_activeLightParticleIndex = 0x1A10;
    constexpr std::ptrdiff_t m_eActiveLightEffect = 0x1A14;
    constexpr std::ptrdiff_t m_bStartedArming = 0x1A18;
    constexpr std::ptrdiff_t m_fArmedTime = 0x1A1C;
    constexpr std::ptrdiff_t m_bBombPlacedAnimation = 0x1A20;
    constexpr std::ptrdiff_t m_bIsPlantingViaUse = 0x1A21;
    constexpr std::ptrdiff_t m_entitySpottedState = 0x1A28;
    constexpr std::ptrdiff_t m_nSpotRules = 0x1A40;
    constexpr std::ptrdiff_t m_bPlayedArmingBeeps = 0x1A44;
    constexpr std::ptrdiff_t m_bBombPlanted = 0x1A4B;
    constexpr std::ptrdiff_t m_bDroppedFromDeath = 0x1A4C;
}
...
namespace C_CSGO_PreviewPlayer {
    constexpr std::ptrdiff_t m_animgraph = 0x22E8;
    constexpr std::ptrdiff_t m_animgraphCharacterModeString = 0x22F0;
    constexpr std::ptrdiff_t m_flInitialModelScale = 0x22F8;
}
...
namespace C_CSObserverPawn {
    constexpr std::ptrdiff_t m_hDetectParentChange = 0x16B0;
}

namespace C_CSPlayerPawn {
    constexpr std::ptrdiff_t m_pBulletServices = 0x16B0;
    constexpr std::ptrdiff_t m_pHostageServices = 0x16B8;
    constexpr std::ptrdiff_t m_pBuyServices = 0x16C0;
    constexpr std::ptrdiff_t m_pGlowServices = 0x16C8;
    constexpr std::ptrdiff_t m_pActionTrackingServices = 0x16D0;
    constexpr std::ptrdiff_t m_flHealthShotBoostExpirationTime = 0x16D8;
    constexpr std::ptrdiff_t m_flLastFiredWeaponTime = 0x16DC;
    constexpr std::ptrdiff_t m_bHasFemaleVoice = 0x16E0;
    constexpr std::ptrdiff_t m_flLandseconds = 0x16E4;
    constexpr std::ptrdiff_t m_flOldFallVelocity = 0x16E8;
    constexpr std::ptrdiff_t m_szLastPlaceName = 0x16EC;
    constexpr std::ptrdiff_t m_bPrevDefuser = 0x16FE;
    constexpr std::ptrdiff_t m_bPrevHelmet = 0x16FF;
    constexpr std::ptrdiff_t m_nPrevArmorVal = 0x1700;
    constexpr std::ptrdiff_t m_nPrevGrenadeAmmoCount = 0x1704;
    constexpr std::ptrdiff_t m_unPreviousWeaponHash = 0x1708;
    constexpr std::ptrdiff_t m_unWeaponHash = 0x170C;
    constexpr std::ptrdiff_t m_bInBuyZone = 0x1710;
    constexpr std::ptrdiff_t m_bPreviouslyInBuyZone = 0x1711;
    constexpr std::ptrdiff_t m_aimPunchAngle = 0x1714;
    constexpr std::ptrdiff_t m_aimPunchAngleVel = 0x1720;
    constexpr std::ptrdiff_t m_aimPunchTickBase = 0x172C;
    constexpr std::ptrdiff_t m_aimPunchTickFraction = 0x1730;
    constexpr std::ptrdiff_t m_aimPunchCache = 0x1738;
    constexpr std::ptrdiff_t m_bInLanding = 0x1758;
    constexpr std::ptrdiff_t m_flLandingTime = 0x175C;
    constexpr std::ptrdiff_t m_bInHostageRescueZone = 0x1760;
    constexpr std::ptrdiff_t m_bInBombZone = 0x1761;
    constexpr std::ptrdiff_t m_bIsBuyMenuOpen = 0x1762;
    constexpr std::ptrdiff_t m_flTimeOfLastInjury = 0x1764;
    constexpr std::ptrdiff_t m_flNextSprayDecalTime = 0x1768;
    constexpr std::ptrdiff_t m_iRetakesOffering = 0x1880;
    constexpr std::ptrdiff_t m_iRetakesOfferingCard = 0x1884;
    constexpr std::ptrdiff_t m_bRetakesHasDefuseKit = 0x1888;
    constexpr std::ptrdiff_t m_bRetakesMVPLastRound = 0x1889;
    constexpr std::ptrdiff_t m_iRetakesMVPBoostItem = 0x188C;
    constexpr std::ptrdiff_t m_RetakesMVPBoostExtraUtility = 0x1890;
    constexpr std::ptrdiff_t m_bNeedToReApplyGloves = 0x18B0;
    constexpr std::ptrdiff_t m_EconGloves = 0x18B8;
    constexpr std::ptrdiff_t m_bMustSyncRagdollState = 0x1D00;
    ...
    constexpr std::ptrdiff_t m_bLastHeadBoneTransformIsValid = 0x22B0;
    constexpr std::ptrdiff_t m_lastLandTime = 0x22B4;
    constexpr std::ptrdiff_t m_bOnGroundLastTick = 0x22B8;
    constexpr std::ptrdiff_t m_qDeathEyeAngles = 0x22D4;
    constexpr std::ptrdiff_t m_bSkipOneHeadConstraintUpdate = 0x22E0;
}

namespace C_CSPlayerPawnBase {
    constexpr std::ptrdiff_t m_pPingServices = 0x1268;
    constexpr std::ptrdiff_t m_pViewModelServices = 0x1270;
    constexpr std::ptrdiff_t m_fRenderingClipPlane = 0x1278;
    constexpr std::ptrdiff_t m_nLastClipPlaneSetupFrame = 0x1288;
    constexpr std::ptrdiff_t m_vecLastClipCameraPos = 0x128C;
    constexpr std::ptrdiff_t m_vecLastClipCameraForward = 0x1298;
    constexpr std::ptrdiff_t m_bClipHitStaticWorld = 0x12A4;
    constexpr std::ptrdiff_t m_bCachedPlaneIsValid = 0x12A5;
    constexpr std::ptrdiff_t m_pClippingWeapon = 0x12A8;
    constexpr std::ptrdiff_t m_previousPlayerState = 0x12B0;
    constexpr std::ptrdiff_t m_flLastCollisionCeiling = 0x12B4;
    constexpr std::ptrdiff_t m_flLastCollisionCeilingChangeTime = 0x12B8;
    constexpr std::ptrdiff_t m_grenadeParameterStashTime = 0x12D8;
    constexpr std::ptrdiff_t m_bGrenadeParametersStashed = 0x12DC;
    constexpr std::ptrdiff_t m_angStashedShootAngles = 0x12E0;
    constexpr std::ptrdiff_t m_vecStashedGrenadeThrowPosition = 0x12EC;
    constexpr std::ptrdiff_t m_vecStashedVelocity = 0x12F8;
    constexpr std::ptrdiff_t m_angShootAngleHistory = 0x1304;
    constexpr std::ptrdiff_t m_vecThrowPositionHistory = 0x131C;
    constexpr std::ptrdiff_t m_vecVelocityHistory = 0x1334;
    constexpr std::ptrdiff_t m_thirdPersonHeading = 0x1350;
    constexpr std::ptrdiff_t m_flSlopeDropOffset = 0x1368;
    constexpr std::ptrdiff_t m_flSlopeDropHeight = 0x1378;
    constexpr std::ptrdiff_t m_vHeadConstraintOffset = 0x1388;
    constexpr std::ptrdiff_t m_bIsScoped = 0x13A0;
    constexpr std::ptrdiff_t m_bIsWalking = 0x13A1;
    constexpr std::ptrdiff_t m_bResumeZoom = 0x13A2;
    constexpr std::ptrdiff_t m_iPlayerState = 0x13A4;
    constexpr std::ptrdiff_t m_bIsDefusing = 0x13A8;
    constexpr std::ptrdiff_t m_bIsGrabbingHostage = 0x13A9;
    constexpr std::ptrdiff_t m_iBlockingUseActionInProgress = 0x13AC;
    ...
    constexpr std::ptrdiff_t m_nWhichBombZone = 0x13C8;
    constexpr std::ptrdiff_t m_bInNoDefuseArea = 0x13CC;
    constexpr std::ptrdiff_t m_iThrowGrenadeCounter = 0x13D0;
    constexpr std::ptrdiff_t m_bWaitForNoAttack = 0x13D4;
    constexpr std::ptrdiff_t m_flGuardianTooFarDistFrac = 0x13D8;
    constexpr std::ptrdiff_t m_flDetectedByEnemySensorTime = 0x13DC;
    constexpr std::ptrdiff_t m_flNextGuardianTooFarWarning = 0x13E0;
    constexpr std::ptrdiff_t m_bSuppressGuardianTooFarWarningAudio = 0x13E4;
    constexpr std::ptrdiff_t m_bKilledByTaser = 0x13E5;
    constexpr std::ptrdiff_t m_iMoveState = 0x13E8;
    constexpr std::ptrdiff_t m_bCanMoveDuringFreezePeriod = 0x13EC;
    constexpr std::ptrdiff_t m_flLowerBodyYawTarget = 0x13F0;
    constexpr std::ptrdiff_t m_bStrafing = 0x13F4;
    constexpr std::ptrdiff_t m_flLastSpawnTimeIndex = 0x13F8;
    constexpr std::ptrdiff_t m_flEmitSoundTime = 0x13FC;
    constexpr std::ptrdiff_t m_iAddonBits = 0x1400;
    constexpr std::ptrdiff_t m_iPrimaryAddon = 0x1404;
    constexpr std::ptrdiff_t m_iSecondaryAddon = 0x1408;
    constexpr std::ptrdiff_t m_iProgressBarDuration = 0x140C;
    constexpr std::ptrdiff_t m_flProgressBarStartTime = 0x1410;
    constexpr std::ptrdiff_t m_iDirection = 0x1414;
    constexpr std::ptrdiff_t m_iShotsFired = 0x1418;
    constexpr std::ptrdiff_t m_bNightVisionOn = 0x141C;
    constexpr std::ptrdiff_t m_bHasNightVision = 0x141D;
    constexpr std::ptrdiff_t m_flVelocityModifier = 0x1420;
    constexpr std::ptrdiff_t m_flHitHeading = 0x1424;
    constexpr std::ptrdiff_t m_nHitBodyPart = 0x1428;
    constexpr std::ptrdiff_t m_iStartAccount = 0x142C;
    constexpr std::ptrdiff_t m_vecIntroStartEyePosition = 0x1430;
    constexpr std::ptrdiff_t m_vecIntroStartPlayerForward = 0x143C;
    constexpr std::ptrdiff_t m_flClientDeathTime = 0x1448;
    constexpr std::ptrdiff_t m_flNightVisionAlpha = 0x144C;
    constexpr std::ptrdiff_t m_bScreenTearFrameCaptured = 0x1450;
    constexpr std::ptrdiff_t m_flFlashBangTime = 0x1454;
    constexpr std::ptrdiff_t m_flFlashScreenshotAlpha = 0x1458;
    constexpr std::ptrdiff_t m_flFlashOverlayAlpha = 0x145C;
    constexpr std::ptrdiff_t m_bFlashBuildUp = 0x1460;
    constexpr std::ptrdiff_t m_bFlashDspHasBeenCleared = 0x1461;
    constexpr std::ptrdiff_t m_bFlashScreenshotHasBeenGrabbed = 0x1462;
    constexpr std::ptrdiff_t m_flFlashMaxAlpha = 0x1464;
    constexpr std::ptrdiff_t m_flFlashDuration = 0x1468;
    constexpr std::ptrdiff_t m_lastStandingPos = 0x146C;
    constexpr std::ptrdiff_t m_vecLastMuzzleFlashPos = 0x1478;
    constexpr std::ptrdiff_t m_angLastMuzzleFlashAngle = 0x1484;
    constexpr std::ptrdiff_t m_hMuzzleFlashShape = 0x1490;
    constexpr std::ptrdiff_t m_iHealthBarRenderMaskIndex = 0x1494;
    constexpr std::ptrdiff_t m_flHealthFadeValue = 0x1498;
    constexpr std::ptrdiff_t m_flHealthFadeAlpha = 0x149C;
    constexpr std::ptrdiff_t m_nMyCollisionGroup = 0x14A0;
    constexpr std::ptrdiff_t m_ignoreLadderJumpTime = 0x14A4;
    constexpr std::ptrdiff_t m_ladderSurpressionTimer = 0x14A8;
    constexpr std::ptrdiff_t m_lastLadderNormal = 0x14C0;
    constexpr std::ptrdiff_t m_lastLadderPos = 0x14CC;
    constexpr std::ptrdiff_t m_flDeathCCWeight = 0x14E0;
    constexpr std::ptrdiff_t m_bOldIsScoped = 0x14E4;
    constexpr std::ptrdiff_t m_flPrevRoundEndTime = 0x14E8;
    constexpr std::ptrdiff_t m_flPrevMatchEndTime = 0x14EC;
    constexpr std::ptrdiff_t m_unCurrentEquipmentValue = 0x14F0;
    constexpr std::ptrdiff_t m_unRoundStartEquipmentValue = 0x14F2;
    constexpr std::ptrdiff_t m_unFreezetimeEndEquipmentValue = 0x14F4;
    constexpr std::ptrdiff_t m_vecThirdPersonViewPositionOverride = 0x14F8;
    constexpr std::ptrdiff_t m_nHeavyAssaultSuitCooldownRemaining = 0x1504;
    constexpr std::ptrdiff_t m_ArmorValue = 0x1508;
    constexpr std::ptrdiff_t m_angEyeAngles = 0x1510;
    constexpr std::ptrdiff_t m_fNextThinkPushAway = 0x1528;
    constexpr std::ptrdiff_t m_bShouldAutobuyDMWeapons = 0x152C;
    constexpr std::ptrdiff_t m_bShouldAutobuyNow = 0x152D;
    constexpr std::ptrdiff_t m_bHud_MiniScoreHidden = 0x152E;
    constexpr std::ptrdiff_t m_bHud_RadarHidden = 0x152F;
    constexpr std::ptrdiff_t m_nLastKillerIndex = 0x1530;
    constexpr std::ptrdiff_t m_nLastConcurrentKilled = 0x1534;
    constexpr std::ptrdiff_t m_nDeathCamMusic = 0x1538;
    constexpr std::ptrdiff_t m_iIDEntIndex = 0x153C;
    constexpr std::ptrdiff_t m_delayTargetIDTimer = 0x1540;
    constexpr std::ptrdiff_t m_iTargetedWeaponEntIndex = 0x1558;
    constexpr std::ptrdiff_t m_iOldIDEntIndex = 0x155C;
    constexpr std::ptrdiff_t m_holdTargetIDTimer = 0x1560;
    constexpr std::ptrdiff_t m_flCurrentMusicStartTime = 0x157C;
    constexpr std::ptrdiff_t m_flMusicRoundStartTime = 0x1580;
    constexpr std::ptrdiff_t m_bDeferStartMusicOnWarmup = 0x1584;
    constexpr std::ptrdiff_t m_cycleLatch = 0x1588;
    constexpr std::ptrdiff_t m_serverIntendedCycle = 0x158C;
    constexpr std::ptrdiff_t m_vecPlayerPatchEconIndices = 0x1590;
    constexpr std::ptrdiff_t m_bHideTargetID = 0x15AC;
    constexpr std::ptrdiff_t m_nextTaserShakeTime = 0x15B0;
    constexpr std::ptrdiff_t m_firstTaserShakeTime = 0x15B4;
    constexpr std::ptrdiff_t m_flLastSmokeOverlayAlpha = 0x15B8;
    constexpr std::ptrdiff_t m_vLastSmokeOverlayColor = 0x15BC;
    constexpr std::ptrdiff_t m_nPlayerSmokedFx = 0x15C8;
    constexpr std::ptrdiff_t m_flNextMagDropTime = 0x15CC;
    constexpr std::ptrdiff_t m_nLastMagDropAttachmentIndex = 0x15D0;
    constexpr std::ptrdiff_t m_vecBulletHitModels = 0x15D8;
    constexpr std::ptrdiff_t m_vecPickupModelSlerpers = 0x15F0;
    constexpr std::ptrdiff_t m_vecLastAliveLocalVelocity = 0x1608;
    constexpr std::ptrdiff_t m_entitySpottedState = 0x1630;
    constexpr std::ptrdiff_t m_nSurvivalTeamNumber = 0x1648;
    constexpr std::ptrdiff_t m_bGuardianShouldSprayCustomXMark = 0x164C;
    constexpr std::ptrdiff_t m_bHasDeathInfo = 0x164D;
    constexpr std::ptrdiff_t m_flDeathInfoTime = 0x1650;
    constexpr std::ptrdiff_t m_vecDeathInfoOrigin = 0x1654;
    constexpr std::ptrdiff_t m_bKilledByHeadshot = 0x1660;
    constexpr std::ptrdiff_t m_hOriginalController = 0x1664;
}
...
namespace C_CSWeaponBase {
    ...
    constexpr std::ptrdiff_t m_bPlayerFireEventIsPrimary = 0x15E0;
    constexpr std::ptrdiff_t m_seqIdle = 0x15E4;
    constexpr std::ptrdiff_t m_seqFirePrimary = 0x15E8;
    constexpr std::ptrdiff_t m_seqFireSecondary = 0x15EC;
    constexpr std::ptrdiff_t m_thirdPersonFireSequences = 0x15F0;
    constexpr std::ptrdiff_t m_hCurrentThirdPersonSequence = 0x1608;
    constexpr std::ptrdiff_t m_nSilencerBoneIndex = 0x160C;
    constexpr std::ptrdiff_t m_thirdPersonSequences = 0x1610;
    constexpr std::ptrdiff_t m_ClientPreviousWeaponState = 0x1640;
    constexpr std::ptrdiff_t m_iState = 0x1644;
    constexpr std::ptrdiff_t m_flCrosshairDistance = 0x1648;
    constexpr std::ptrdiff_t m_iAmmoLastCheck = 0x164C;
    constexpr std::ptrdiff_t m_iAlpha = 0x1650;
    constexpr std::ptrdiff_t m_iScopeTextureID = 0x1654;
    constexpr std::ptrdiff_t m_iCrosshairTextureID = 0x1658;
    constexpr std::ptrdiff_t m_flGunAccuracyPosition = 0x165C;
    constexpr std::ptrdiff_t m_nViewModelIndex = 0x1660;
    constexpr std::ptrdiff_t m_bReloadsWithClips = 0x1664;
    constexpr std::ptrdiff_t m_flTimeWeaponIdle = 0x1668;
    constexpr std::ptrdiff_t m_bFireOnEmpty = 0x166C;
    constexpr std::ptrdiff_t m_OnPlayerPickup = 0x1670;
    constexpr std::ptrdiff_t m_weaponMode = 0x1698;
    constexpr std::ptrdiff_t m_flTurningInaccuracyDelta = 0x169C;
    constexpr std::ptrdiff_t m_vecTurningInaccuracyEyeDirLast = 0x16A0;
    constexpr std::ptrdiff_t m_flTurningInaccuracy = 0x16AC;
    constexpr std::ptrdiff_t m_fAccuracyPenalty = 0x16B0;
    constexpr std::ptrdiff_t m_flLastAccuracyUpdateTime = 0x16B4;
    constexpr std::ptrdiff_t m_fAccuracySmoothedForZoom = 0x16B8;
    constexpr std::ptrdiff_t m_fScopeZoomEndTime = 0x16BC;
    constexpr std::ptrdiff_t m_iRecoilIndex = 0x16C0;
    constexpr std::ptrdiff_t m_flRecoilIndex = 0x16C4;
    constexpr std::ptrdiff_t m_bBurstMode = 0x16C8;
    constexpr std::ptrdiff_t m_flPostponeFireReadyTime = 0x16CC;
    constexpr std::ptrdiff_t m_bInReload = 0x16D0;
    constexpr std::ptrdiff_t m_bReloadVisuallyComplete = 0x16D1;
    constexpr std::ptrdiff_t m_flDroppedAtTime = 0x16D4;
    constexpr std::ptrdiff_t m_bIsHauledBack = 0x16D8;
    constexpr std::ptrdiff_t m_bSilencerOn = 0x16D9;
    constexpr std::ptrdiff_t m_flTimeSilencerSwitchComplete = 0x16DC;
    constexpr std::ptrdiff_t m_iOriginalTeamNumber = 0x16E0;
    constexpr std::ptrdiff_t m_flNextAttackRenderTimeOffset = 0x16E4;
    constexpr std::ptrdiff_t m_bVisualsDataSet = 0x1768;
    constexpr std::ptrdiff_t m_bOldFirstPersonSpectatedState = 0x1769;
    constexpr std::ptrdiff_t m_hOurPing = 0x176C;
    constexpr std::ptrdiff_t m_nOurPingIndex = 0x1770;
    constexpr std::ptrdiff_t m_vecOurPingPos = 0x1774;
    constexpr std::ptrdiff_t m_bGlowForPing = 0x1780;
    constexpr std::ptrdiff_t m_bUIWeapon = 0x1781;
    constexpr std::ptrdiff_t m_hPrevOwner = 0x1790;
    constexpr std::ptrdiff_t m_nDropTick = 0x1794;
    constexpr std::ptrdiff_t m_donated = 0x17B4;
    constexpr std::ptrdiff_t m_fLastShotTime = 0x17B8;
    constexpr std::ptrdiff_t m_bWasOwnedByCT = 0x17BC;
    constexpr std::ptrdiff_t m_bWasOwnedByTerrorist = 0x17BD;
    constexpr std::ptrdiff_t m_gunHeat = 0x17C0;
    constexpr std::ptrdiff_t m_smokeAttachments = 0x17C4;
    constexpr std::ptrdiff_t m_lastSmokeTime = 0x17C8;
    constexpr std::ptrdiff_t m_flNextClientFireBulletTime = 0x17CC;
    constexpr std::ptrdiff_t m_flNextClientFireBulletTime_Repredict = 0x17D0;
    constexpr std::ptrdiff_t m_IronSightController = 0x18B0;
    constexpr std::ptrdiff_t m_iIronSightMode = 0x1960;
    constexpr std::ptrdiff_t m_flLastLOSTraceFailureTime = 0x1970;
    constexpr std::ptrdiff_t m_iNumEmptyAttacks = 0x1974;
}

namespace C_CSWeaponBaseGun {
    constexpr std::ptrdiff_t m_zoomLevel = 0x19F0;
    constexpr std::ptrdiff_t m_iBurstShotsRemaining = 0x19F4;
    constexpr std::ptrdiff_t m_iSilencerBodygroup = 0x19F8;
    constexpr std::ptrdiff_t m_silencedModelIndex = 0x1A08;
    constexpr std::ptrdiff_t m_inPrecache = 0x1A0C;
    constexpr std::ptrdiff_t m_bNeedsBoltAction = 0x1A0D;
}
...
namespace C_Fists {
    constexpr std::ptrdiff_t m_bPlayingUninterruptableAct = 0x19F0;
    constexpr std::ptrdiff_t m_nUninterruptableActivity = 0x19F4;
}
...
namespace C_Melee {
    constexpr std::ptrdiff_t m_flThrowAt = 0x19F0;
}
...
namespace C_WeaponBaseItem {
    constexpr std::ptrdiff_t m_SequenceCompleteTimer = 0x19F0;
    constexpr std::ptrdiff_t m_bRedraw = 0x1A08;
}

namespace C_WeaponShield {
    constexpr std::ptrdiff_t m_flDisplayHealth = 0x1A10;
}

namespace C_WeaponTaser {
    constexpr std::ptrdiff_t m_fFireTime = 0x1A10;
}
