...
namespace CBasePlayerController {
    ...
    constexpr std::ptrdiff_t m_hPredictedPawn = 0x610;
    constexpr std::ptrdiff_t m_nSplitScreenSlot = 0x614;
    constexpr std::ptrdiff_t m_hSplitOwner = 0x618;
...
namespace CBodyComponentBaseAnimGraph {
    constexpr std::ptrdiff_t m_animationController = 0x480;
    constexpr std::ptrdiff_t __m_pChainEntity = 0x18C0;
}

namespace CBodyComponentBaseModelEntity {
    constexpr std::ptrdiff_t __m_pChainEntity = 0x480;
}
...
namespace CBodyComponentSkeletonInstance {
    ...
    constexpr std::ptrdiff_t __m_pChainEntity = 0x450;
}
...
namespace CCSPlayerController {
    constexpr std::ptrdiff_t m_pInGameMoneyServices = 0x700;
    constexpr std::ptrdiff_t m_pInventoryServices = 0x708;
...
namespace CCSPlayerController_ActionTrackingServices {
    ...
    constexpr std::ptrdiff_t m_unTotalRoundDamageDealt = 0x110;
}
...
namespace CCSPlayer_MovementServices {
    ...
    constexpr std::ptrdiff_t m_flHeightAtJumpStart = 0x4D8;
    constexpr std::ptrdiff_t m_flMaxJumpHeightThisJump = 0x4DC;
}
...
namespace C_BaseCSGrenade {
    constexpr std::ptrdiff_t m_bClientPredictDelete = 0x1A10;
    constexpr std::ptrdiff_t m_bRedraw = 0x1A11;
    constexpr std::ptrdiff_t m_bIsHeldByPlayer = 0x1A12;
    constexpr std::ptrdiff_t m_bPinPulled = 0x1A13;
    constexpr std::ptrdiff_t m_bJumpThrow = 0x1A14;
    constexpr std::ptrdiff_t m_bThrowAnimating = 0x1A15;
    constexpr std::ptrdiff_t m_fThrowTime = 0x1A18;
    constexpr std::ptrdiff_t m_flThrowStrength = 0x1A1C;
    constexpr std::ptrdiff_t m_flThrowStrengthApproach = 0x1A20;
    constexpr std::ptrdiff_t m_fDropTime = 0x1A24;
    constexpr std::ptrdiff_t m_bJustPulledPin = 0x1A28;
    constexpr std::ptrdiff_t m_nNextHoldTick = 0x1A2C;
    constexpr std::ptrdiff_t m_flNextHoldFrac = 0x1A30;
    constexpr std::ptrdiff_t m_hSwitchToWeaponAfterThrow = 0x1A34;
}

namespace C_BaseCSGrenadeProjectile {
    constexpr std::ptrdiff_t m_vInitialPosition = 0x1068;
    constexpr std::ptrdiff_t m_vInitialVelocity = 0x1074;
    constexpr std::ptrdiff_t m_nBounces = 0x1080;
    constexpr std::ptrdiff_t m_nExplodeEffectIndex = 0x1088;
    constexpr std::ptrdiff_t m_nExplodeEffectTickBegin = 0x1090;
    constexpr std::ptrdiff_t m_vecExplodeEffectOrigin = 0x1094;
    constexpr std::ptrdiff_t m_flSpawnTime = 0x10A0;
    constexpr std::ptrdiff_t vecLastTrailLinePos = 0x10A4;
    constexpr std::ptrdiff_t flNextTrailLineTime = 0x10B0;
    constexpr std::ptrdiff_t m_bExplodeEffectBegan = 0x10B4;
    constexpr std::ptrdiff_t m_bCanCreateGrenadeTrail = 0x10B5;
    constexpr std::ptrdiff_t m_nSnapshotTrajectoryEffectIndex = 0x10B8;
    constexpr std::ptrdiff_t m_hSnapshotTrajectoryParticleSnapshot = 0x10C0;
    constexpr std::ptrdiff_t m_arrTrajectoryTrailPoints = 0x10C8;
    constexpr std::ptrdiff_t m_arrTrajectoryTrailPointCreationTimes = 0x10E0;
    constexpr std::ptrdiff_t m_flTrajectoryTrailEffectCreationTime = 0x10F8;
}
...
namespace C_BaseModelEntity {
    ...
    constexpr std::ptrdiff_t m_bRenderToCubemaps = 0xAE0;
...
namespace C_BasePlayerPawn {
    ...
    constexpr std::ptrdiff_t m_vecLastCameraSetupLocalOrigin = 0x120C;
    constexpr std::ptrdiff_t m_flLastCameraSetupTime = 0x1218;
    constexpr std::ptrdiff_t m_flFOVSensitivityAdjust = 0x121C;
    constexpr std::ptrdiff_t m_flMouseSensitivity = 0x1220;
    constexpr std::ptrdiff_t m_vOldOrigin = 0x1224;
    constexpr std::ptrdiff_t m_flOldSimulationTime = 0x1230;
    constexpr std::ptrdiff_t m_nLastExecutedCommandNumber = 0x1234;
    constexpr std::ptrdiff_t m_nLastExecutedCommandTick = 0x1238;
    constexpr std::ptrdiff_t m_hController = 0x123C;
    constexpr std::ptrdiff_t m_bIsSwappingToPredictableController = 0x1240;
}
...
namespace C_C4 {
    constexpr std::ptrdiff_t m_szScreenText = 0x1A10;
    constexpr std::ptrdiff_t m_activeLightParticleIndex = 0x1A30;
    constexpr std::ptrdiff_t m_eActiveLightEffect = 0x1A34;
    constexpr std::ptrdiff_t m_bStartedArming = 0x1A38;
    constexpr std::ptrdiff_t m_fArmedTime = 0x1A3C;
    constexpr std::ptrdiff_t m_bBombPlacedAnimation = 0x1A40;
    constexpr std::ptrdiff_t m_bIsPlantingViaUse = 0x1A41;
    constexpr std::ptrdiff_t m_entitySpottedState = 0x1A48;
    constexpr std::ptrdiff_t m_nSpotRules = 0x1A60;
    constexpr std::ptrdiff_t m_bPlayedArmingBeeps = 0x1A64;
    constexpr std::ptrdiff_t m_bBombPlanted = 0x1A6B;
    constexpr std::ptrdiff_t m_bDroppedFromDeath = 0x1A6C;
}
...
namespace C_CSGO_PreviewPlayer {
    constexpr std::ptrdiff_t m_animgraph = 0x23B8;
    constexpr std::ptrdiff_t m_animgraphCharacterModeString = 0x23C0;
    constexpr std::ptrdiff_t m_flInitialModelScale = 0x23C8;
}
...
namespace C_CSGO_TeamPreviewCharacterPosition {
    ...
    constexpr std::ptrdiff_t m_agentItem = 0x560;
    constexpr std::ptrdiff_t m_glovesItem = 0x9A8;
    constexpr std::ptrdiff_t m_weaponItem = 0xDF0;
}
...
namespace C_CSGameRules {
    ...
    constexpr std::ptrdiff_t m_flLastPerfSampleTime = 0x4EC0;
}
...
namespace C_CSObserverPawn {
    constexpr std::ptrdiff_t m_hDetectParentChange = 0x16B8;
}

namespace C_CSPlayerPawn {
    constexpr std::ptrdiff_t m_pBulletServices = 0x16B8;
    constexpr std::ptrdiff_t m_pHostageServices = 0x16C0;
    constexpr std::ptrdiff_t m_pBuyServices = 0x16C8;
    constexpr std::ptrdiff_t m_pGlowServices = 0x16D0;
    constexpr std::ptrdiff_t m_pActionTrackingServices = 0x16D8;
    constexpr std::ptrdiff_t m_flHealthShotBoostExpirationTime = 0x16E0;
    constexpr std::ptrdiff_t m_flLastFiredWeaponTime = 0x16E4;
    constexpr std::ptrdiff_t m_bHasFemaleVoice = 0x16E8;
    constexpr std::ptrdiff_t m_flLandseconds = 0x16EC;
    constexpr std::ptrdiff_t m_flOldFallVelocity = 0x16F0;
    constexpr std::ptrdiff_t m_szLastPlaceName = 0x16F4;
    constexpr std::ptrdiff_t m_bPrevDefuser = 0x1706;
    constexpr std::ptrdiff_t m_bPrevHelmet = 0x1707;
    constexpr std::ptrdiff_t m_nPrevArmorVal = 0x1708;
    constexpr std::ptrdiff_t m_nPrevGrenadeAmmoCount = 0x170C;
    constexpr std::ptrdiff_t m_unPreviousWeaponHash = 0x1710;
    constexpr std::ptrdiff_t m_unWeaponHash = 0x1714;
    constexpr std::ptrdiff_t m_bInBuyZone = 0x1718;
    constexpr std::ptrdiff_t m_bPreviouslyInBuyZone = 0x1719;
    constexpr std::ptrdiff_t m_aimPunchAngle = 0x171C;
    constexpr std::ptrdiff_t m_aimPunchAngleVel = 0x1728;
    constexpr std::ptrdiff_t m_aimPunchTickBase = 0x1734;
    constexpr std::ptrdiff_t m_aimPunchTickFraction = 0x1738;
    constexpr std::ptrdiff_t m_aimPunchCache = 0x1740;
    constexpr std::ptrdiff_t m_bInLanding = 0x1760;
    constexpr std::ptrdiff_t m_flLandingTime = 0x1764;
    constexpr std::ptrdiff_t m_bInHostageRescueZone = 0x1768;
    constexpr std::ptrdiff_t m_bInBombZone = 0x1769;
    constexpr std::ptrdiff_t m_bIsBuyMenuOpen = 0x176A;
    constexpr std::ptrdiff_t m_flTimeOfLastInjury = 0x176C;
    constexpr std::ptrdiff_t m_flNextSprayDecalTime = 0x1770;
    constexpr std::ptrdiff_t m_iRetakesOffering = 0x1888;
    constexpr std::ptrdiff_t m_iRetakesOfferingCard = 0x188C;
    constexpr std::ptrdiff_t m_bRetakesHasDefuseKit = 0x1890;
    constexpr std::ptrdiff_t m_bRetakesMVPLastRound = 0x1891;
    constexpr std::ptrdiff_t m_iRetakesMVPBoostItem = 0x1894;
    constexpr std::ptrdiff_t m_RetakesMVPBoostExtraUtility = 0x1898;
    constexpr std::ptrdiff_t m_bNeedToReApplyGloves = 0x18B8;
    constexpr std::ptrdiff_t m_EconGloves = 0x18C0;
    constexpr std::ptrdiff_t m_bMustSyncRagdollState = 0x1D08;
    constexpr std::ptrdiff_t m_nRagdollDamageBone = 0x1D0C;
    constexpr std::ptrdiff_t m_vRagdollDamageForce = 0x1D10;
    constexpr std::ptrdiff_t m_vRagdollDamagePosition = 0x1D1C;
    constexpr std::ptrdiff_t m_szRagdollDamageWeaponName = 0x1D28;
    constexpr std::ptrdiff_t m_bRagdollDamageHeadshot = 0x1D68;
    constexpr std::ptrdiff_t m_vRagdollServerOrigin = 0x1D6C;
    constexpr std::ptrdiff_t m_bLastHeadBoneTransformIsValid = 0x2380;
    constexpr std::ptrdiff_t m_lastLandTime = 0x2384;
    constexpr std::ptrdiff_t m_bOnGroundLastTick = 0x2388;
    constexpr std::ptrdiff_t m_qDeathEyeAngles = 0x23A4;
    constexpr std::ptrdiff_t m_bSkipOneHeadConstraintUpdate = 0x23B0;
}

namespace C_CSPlayerPawnBase {
    constexpr std::ptrdiff_t m_pPingServices = 0x1268;
    constexpr std::ptrdiff_t m_pViewModelServices = 0x1270;
    constexpr std::ptrdiff_t m_fRenderingClipPlane = 0x1280;
    constexpr std::ptrdiff_t m_nLastClipPlaneSetupFrame = 0x1290;
    constexpr std::ptrdiff_t m_vecLastClipCameraPos = 0x1294;
    constexpr std::ptrdiff_t m_vecLastClipCameraForward = 0x12A0;
    constexpr std::ptrdiff_t m_bClipHitStaticWorld = 0x12AC;
    constexpr std::ptrdiff_t m_bCachedPlaneIsValid = 0x12AD;
    constexpr std::ptrdiff_t m_pClippingWeapon = 0x12B0;
    constexpr std::ptrdiff_t m_previousPlayerState = 0x12B8;
    constexpr std::ptrdiff_t m_flLastCollisionCeiling = 0x12BC;
    constexpr std::ptrdiff_t m_flLastCollisionCeilingChangeTime = 0x12C0;
    constexpr std::ptrdiff_t m_grenadeParameterStashTime = 0x12E0;
    constexpr std::ptrdiff_t m_bGrenadeParametersStashed = 0x12E4;
    constexpr std::ptrdiff_t m_angStashedShootAngles = 0x12E8;
    constexpr std::ptrdiff_t m_vecStashedGrenadeThrowPosition = 0x12F4;
    constexpr std::ptrdiff_t m_vecStashedVelocity = 0x1300;
    constexpr std::ptrdiff_t m_angShootAngleHistory = 0x130C;
    constexpr std::ptrdiff_t m_vecThrowPositionHistory = 0x1324;
    constexpr std::ptrdiff_t m_vecVelocityHistory = 0x133C;
    constexpr std::ptrdiff_t m_thirdPersonHeading = 0x1358;
    constexpr std::ptrdiff_t m_flSlopeDropOffset = 0x1370;
    constexpr std::ptrdiff_t m_flSlopeDropHeight = 0x1380;
    constexpr std::ptrdiff_t m_vHeadConstraintOffset = 0x1390;
    constexpr std::ptrdiff_t m_bIsScoped = 0x13A8;
    constexpr std::ptrdiff_t m_bIsWalking = 0x13A9;
    constexpr std::ptrdiff_t m_bResumeZoom = 0x13AA;
    constexpr std::ptrdiff_t m_iPlayerState = 0x13AC;
    constexpr std::ptrdiff_t m_bIsDefusing = 0x13B0;
    constexpr std::ptrdiff_t m_bIsGrabbingHostage = 0x13B1;
    constexpr std::ptrdiff_t m_iBlockingUseActionInProgress = 0x13B4;
    constexpr std::ptrdiff_t m_bIsRescuing = 0x13B8;
    constexpr std::ptrdiff_t m_fImmuneToGunGameDamageTime = 0x13BC;
    constexpr std::ptrdiff_t m_fImmuneToGunGameDamageTimeLast = 0x13C0;
    constexpr std::ptrdiff_t m_bGunGameImmunity = 0x13C4;
    constexpr std::ptrdiff_t m_bHasMovedSinceSpawn = 0x13C5;
    constexpr std::ptrdiff_t m_fMolotovUseTime = 0x13C8;
    constexpr std::ptrdiff_t m_fMolotovDamageTime = 0x13CC;
    constexpr std::ptrdiff_t m_nWhichBombZone = 0x13D0;
    constexpr std::ptrdiff_t m_bInNoDefuseArea = 0x13D4;
    constexpr std::ptrdiff_t m_iThrowGrenadeCounter = 0x13D8;
    constexpr std::ptrdiff_t m_bWaitForNoAttack = 0x13DC;
    constexpr std::ptrdiff_t m_flGuardianTooFarDistFrac = 0x13E0;
    constexpr std::ptrdiff_t m_flDetectedByEnemySensorTime = 0x13E4;
    constexpr std::ptrdiff_t m_flNextGuardianTooFarWarning = 0x13E8;
    constexpr std::ptrdiff_t m_bSuppressGuardianTooFarWarningAudio = 0x13EC;
    constexpr std::ptrdiff_t m_bKilledByTaser = 0x13ED;
    constexpr std::ptrdiff_t m_iMoveState = 0x13F0;
    constexpr std::ptrdiff_t m_bCanMoveDuringFreezePeriod = 0x13F4;
    constexpr std::ptrdiff_t m_flLowerBodyYawTarget = 0x13F8;
    constexpr std::ptrdiff_t m_bStrafing = 0x13FC;
    constexpr std::ptrdiff_t m_flLastSpawnTimeIndex = 0x1400;
    constexpr std::ptrdiff_t m_flEmitSoundTime = 0x1404;
    constexpr std::ptrdiff_t m_iAddonBits = 0x1408;
    constexpr std::ptrdiff_t m_iPrimaryAddon = 0x140C;
    constexpr std::ptrdiff_t m_iSecondaryAddon = 0x1410;
    constexpr std::ptrdiff_t m_iProgressBarDuration = 0x1414;
    constexpr std::ptrdiff_t m_flProgressBarStartTime = 0x1418;
    constexpr std::ptrdiff_t m_iDirection = 0x141C;
    constexpr std::ptrdiff_t m_iShotsFired = 0x1420;
    constexpr std::ptrdiff_t m_bNightVisionOn = 0x1424;
    constexpr std::ptrdiff_t m_bHasNightVision = 0x1425;
    constexpr std::ptrdiff_t m_flVelocityModifier = 0x1428;
    constexpr std::ptrdiff_t m_flHitHeading = 0x142C;
    constexpr std::ptrdiff_t m_nHitBodyPart = 0x1430;
    constexpr std::ptrdiff_t m_iStartAccount = 0x1434;
    constexpr std::ptrdiff_t m_vecIntroStartEyePosition = 0x1438;
    constexpr std::ptrdiff_t m_vecIntroStartPlayerForward = 0x1444;
    constexpr std::ptrdiff_t m_flClientDeathTime = 0x1450;
    constexpr std::ptrdiff_t m_flNightVisionAlpha = 0x1454;
    constexpr std::ptrdiff_t m_bScreenTearFrameCaptured = 0x1458;
    constexpr std::ptrdiff_t m_flFlashBangTime = 0x145C;
    constexpr std::ptrdiff_t m_flFlashScreenshotAlpha = 0x1460;
    constexpr std::ptrdiff_t m_flFlashOverlayAlpha = 0x1464;
    constexpr std::ptrdiff_t m_bFlashBuildUp = 0x1468;
    constexpr std::ptrdiff_t m_bFlashDspHasBeenCleared = 0x1469;
    constexpr std::ptrdiff_t m_bFlashScreenshotHasBeenGrabbed = 0x146A;
    constexpr std::ptrdiff_t m_flFlashMaxAlpha = 0x146C;
    constexpr std::ptrdiff_t m_flFlashDuration = 0x1470;
    constexpr std::ptrdiff_t m_lastStandingPos = 0x1474;
    constexpr std::ptrdiff_t m_vecLastMuzzleFlashPos = 0x1480;
    constexpr std::ptrdiff_t m_angLastMuzzleFlashAngle = 0x148C;
    constexpr std::ptrdiff_t m_hMuzzleFlashShape = 0x1498;
    constexpr std::ptrdiff_t m_iHealthBarRenderMaskIndex = 0x149C;
    constexpr std::ptrdiff_t m_flHealthFadeValue = 0x14A0;
    constexpr std::ptrdiff_t m_flHealthFadeAlpha = 0x14A4;
    constexpr std::ptrdiff_t m_nMyCollisionGroup = 0x14A8;
    constexpr std::ptrdiff_t m_ignoreLadderJumpTime = 0x14AC;
    constexpr std::ptrdiff_t m_ladderSurpressionTimer = 0x14B0;
    constexpr std::ptrdiff_t m_lastLadderNormal = 0x14C8;
    constexpr std::ptrdiff_t m_lastLadderPos = 0x14D4;
    constexpr std::ptrdiff_t m_flDeathCCWeight = 0x14E8;
    constexpr std::ptrdiff_t m_bOldIsScoped = 0x14EC;
    constexpr std::ptrdiff_t m_flPrevRoundEndTime = 0x14F0;
    constexpr std::ptrdiff_t m_flPrevMatchEndTime = 0x14F4;
    constexpr std::ptrdiff_t m_unCurrentEquipmentValue = 0x14F8;
    constexpr std::ptrdiff_t m_unRoundStartEquipmentValue = 0x14FA;
    constexpr std::ptrdiff_t m_unFreezetimeEndEquipmentValue = 0x14FC;
    constexpr std::ptrdiff_t m_vecThirdPersonViewPositionOverride = 0x1500;
    constexpr std::ptrdiff_t m_nHeavyAssaultSuitCooldownRemaining = 0x150C;
    constexpr std::ptrdiff_t m_ArmorValue = 0x1510;
    constexpr std::ptrdiff_t m_angEyeAngles = 0x1518;
    constexpr std::ptrdiff_t m_fNextThinkPushAway = 0x1530;
    constexpr std::ptrdiff_t m_bShouldAutobuyDMWeapons = 0x1534;
    constexpr std::ptrdiff_t m_bShouldAutobuyNow = 0x1535;
    constexpr std::ptrdiff_t m_bHud_MiniScoreHidden = 0x1536;
    constexpr std::ptrdiff_t m_bHud_RadarHidden = 0x1537;
    constexpr std::ptrdiff_t m_nLastKillerIndex = 0x1538;
    constexpr std::ptrdiff_t m_nLastConcurrentKilled = 0x153C;
    constexpr std::ptrdiff_t m_nDeathCamMusic = 0x1540;
    constexpr std::ptrdiff_t m_iIDEntIndex = 0x1544;
    constexpr std::ptrdiff_t m_delayTargetIDTimer = 0x1548;
    constexpr std::ptrdiff_t m_iTargetedWeaponEntIndex = 0x1560;
    constexpr std::ptrdiff_t m_iOldIDEntIndex = 0x1564;
    constexpr std::ptrdiff_t m_holdTargetIDTimer = 0x1568;
    constexpr std::ptrdiff_t m_flCurrentMusicStartTime = 0x1584;
    constexpr std::ptrdiff_t m_flMusicRoundStartTime = 0x1588;
    constexpr std::ptrdiff_t m_bDeferStartMusicOnWarmup = 0x158C;
    constexpr std::ptrdiff_t m_cycleLatch = 0x1590;
    constexpr std::ptrdiff_t m_serverIntendedCycle = 0x1594;
    constexpr std::ptrdiff_t m_vecPlayerPatchEconIndices = 0x1598;
    constexpr std::ptrdiff_t m_bHideTargetID = 0x15B4;
    constexpr std::ptrdiff_t m_nextTaserShakeTime = 0x15B8;
    constexpr std::ptrdiff_t m_firstTaserShakeTime = 0x15BC;
    constexpr std::ptrdiff_t m_flLastSmokeOverlayAlpha = 0x15C0;
    constexpr std::ptrdiff_t m_vLastSmokeOverlayColor = 0x15C4;
    constexpr std::ptrdiff_t m_nPlayerSmokedFx = 0x15D0;
    constexpr std::ptrdiff_t m_flNextMagDropTime = 0x15D4;
    constexpr std::ptrdiff_t m_nLastMagDropAttachmentIndex = 0x15D8;
    constexpr std::ptrdiff_t m_vecBulletHitModels = 0x15E0;
    constexpr std::ptrdiff_t m_vecPickupModelSlerpers = 0x15F8;
    constexpr std::ptrdiff_t m_vecLastAliveLocalVelocity = 0x1610;
    constexpr std::ptrdiff_t m_entitySpottedState = 0x1638;
    constexpr std::ptrdiff_t m_nSurvivalTeamNumber = 0x1650;
    constexpr std::ptrdiff_t m_bGuardianShouldSprayCustomXMark = 0x1654;
    constexpr std::ptrdiff_t m_bHasDeathInfo = 0x1655;
    constexpr std::ptrdiff_t m_flDeathInfoTime = 0x1658;
    constexpr std::ptrdiff_t m_vecDeathInfoOrigin = 0x165C;
    constexpr std::ptrdiff_t m_bKilledByHeadshot = 0x1668;
    constexpr std::ptrdiff_t m_hOriginalController = 0x166C;
}
...
namespace C_CSWeaponBase {
    constexpr std::ptrdiff_t m_flFireSequenceStartTime = 0x15D4;
    constexpr std::ptrdiff_t m_nFireSequenceStartTimeChange = 0x15D8;
    constexpr std::ptrdiff_t m_nFireSequenceStartTimeAck = 0x15DC;
    constexpr std::ptrdiff_t m_ePlayerFireEvent = 0x15E0;
    constexpr std::ptrdiff_t m_ePlayerFireEventAttackType = 0x15E4;
    constexpr std::ptrdiff_t m_seqIdle = 0x15E8;
    constexpr std::ptrdiff_t m_seqFirePrimary = 0x15EC;
    constexpr std::ptrdiff_t m_seqFireSecondary = 0x15F0;
    constexpr std::ptrdiff_t m_thirdPersonFireSequences = 0x15F8;
    constexpr std::ptrdiff_t m_hCurrentThirdPersonSequence = 0x1610;
    constexpr std::ptrdiff_t m_nSilencerBoneIndex = 0x1614;
    constexpr std::ptrdiff_t m_thirdPersonSequences = 0x1618;
    constexpr std::ptrdiff_t m_ClientPreviousWeaponState = 0x1650;
    constexpr std::ptrdiff_t m_iState = 0x1654;
    constexpr std::ptrdiff_t m_flCrosshairDistance = 0x1658;
    constexpr std::ptrdiff_t m_iAmmoLastCheck = 0x165C;
    constexpr std::ptrdiff_t m_iAlpha = 0x1660;
    constexpr std::ptrdiff_t m_iScopeTextureID = 0x1664;
    constexpr std::ptrdiff_t m_iCrosshairTextureID = 0x1668;
    constexpr std::ptrdiff_t m_flGunAccuracyPosition = 0x166C;
    constexpr std::ptrdiff_t m_nViewModelIndex = 0x1670;
    constexpr std::ptrdiff_t m_bReloadsWithClips = 0x1674;
    constexpr std::ptrdiff_t m_flTimeWeaponIdle = 0x1678;
    constexpr std::ptrdiff_t m_bFireOnEmpty = 0x167C;
    constexpr std::ptrdiff_t m_OnPlayerPickup = 0x1680;
    constexpr std::ptrdiff_t m_weaponMode = 0x16A8;
    constexpr std::ptrdiff_t m_flTurningInaccuracyDelta = 0x16AC;
    constexpr std::ptrdiff_t m_vecTurningInaccuracyEyeDirLast = 0x16B0;
    constexpr std::ptrdiff_t m_flTurningInaccuracy = 0x16BC;
    constexpr std::ptrdiff_t m_fAccuracyPenalty = 0x16C0;
    constexpr std::ptrdiff_t m_flLastAccuracyUpdateTime = 0x16C4;
    constexpr std::ptrdiff_t m_fAccuracySmoothedForZoom = 0x16C8;
    constexpr std::ptrdiff_t m_fScopeZoomEndTime = 0x16CC;
    constexpr std::ptrdiff_t m_iRecoilIndex = 0x16D0;
    constexpr std::ptrdiff_t m_flRecoilIndex = 0x16D4;
    constexpr std::ptrdiff_t m_bBurstMode = 0x16D8;
    constexpr std::ptrdiff_t m_nPostponeFireReadyTicks = 0x16DC;
    constexpr std::ptrdiff_t m_flPostponeFireReadyFrac = 0x16E0;
    constexpr std::ptrdiff_t m_bInReload = 0x16E4;
    constexpr std::ptrdiff_t m_bReloadVisuallyComplete = 0x16E5;
    constexpr std::ptrdiff_t m_flDroppedAtTime = 0x16E8;
    constexpr std::ptrdiff_t m_bIsHauledBack = 0x16EC;
    constexpr std::ptrdiff_t m_bSilencerOn = 0x16ED;
    constexpr std::ptrdiff_t m_flTimeSilencerSwitchComplete = 0x16F0;
    constexpr std::ptrdiff_t m_iOriginalTeamNumber = 0x16F4;
    constexpr std::ptrdiff_t m_flNextAttackRenderTimeOffset = 0x16F8;
    constexpr std::ptrdiff_t m_bVisualsDataSet = 0x1780;
    constexpr std::ptrdiff_t m_bOldFirstPersonSpectatedState = 0x1781;
    constexpr std::ptrdiff_t m_hOurPing = 0x1784;
    constexpr std::ptrdiff_t m_nOurPingIndex = 0x1788;
    constexpr std::ptrdiff_t m_vecOurPingPos = 0x178C;
    constexpr std::ptrdiff_t m_bGlowForPing = 0x1798;
    constexpr std::ptrdiff_t m_bUIWeapon = 0x1799;
    constexpr std::ptrdiff_t m_hPrevOwner = 0x17A8;
    constexpr std::ptrdiff_t m_nDropTick = 0x17AC;
    constexpr std::ptrdiff_t m_donated = 0x17CC;
    constexpr std::ptrdiff_t m_fLastShotTime = 0x17D0;
    constexpr std::ptrdiff_t m_bWasOwnedByCT = 0x17D4;
    constexpr std::ptrdiff_t m_bWasOwnedByTerrorist = 0x17D5;
    constexpr std::ptrdiff_t m_gunHeat = 0x17D8;
    constexpr std::ptrdiff_t m_smokeAttachments = 0x17DC;
    constexpr std::ptrdiff_t m_lastSmokeTime = 0x17E0;
    constexpr std::ptrdiff_t m_flNextClientFireBulletTime = 0x17E4;
    constexpr std::ptrdiff_t m_flNextClientFireBulletTime_Repredict = 0x17E8;
    constexpr std::ptrdiff_t m_IronSightController = 0x18C0;
    constexpr std::ptrdiff_t m_iIronSightMode = 0x1970;
    constexpr std::ptrdiff_t m_flLastLOSTraceFailureTime = 0x1980;
    constexpr std::ptrdiff_t m_iNumEmptyAttacks = 0x1984;
    constexpr std::ptrdiff_t m_flLastMagDropRequestTime = 0x1A00;
}

namespace C_CSWeaponBaseGun {
    constexpr std::ptrdiff_t m_zoomLevel = 0x1A10;
    constexpr std::ptrdiff_t m_iBurstShotsRemaining = 0x1A14;
    constexpr std::ptrdiff_t m_iSilencerBodygroup = 0x1A18;
    constexpr std::ptrdiff_t m_silencedModelIndex = 0x1A28;
    constexpr std::ptrdiff_t m_inPrecache = 0x1A2C;
    constexpr std::ptrdiff_t m_bNeedsBoltAction = 0x1A2D;
}
...
namespace C_CommandContext {
    ...
    constexpr std::ptrdiff_t command_number = 0xA8;
}
...
namespace C_DecoyProjectile {
    constexpr std::ptrdiff_t m_nDecoyShotTick = 0x1100;
    constexpr std::ptrdiff_t m_nClientLastKnownDecoyShotTick = 0x1104;
    constexpr std::ptrdiff_t m_flTimeParticleEffectSpawn = 0x1128;
}
...
namespace C_EnvCombinedLightProbeVolume {
    constexpr std::ptrdiff_t m_Color = 0x1598;
    constexpr std::ptrdiff_t m_flBrightness = 0x159C;
    constexpr std::ptrdiff_t m_hCubemapTexture = 0x15A0;
    constexpr std::ptrdiff_t m_bCustomCubemapTexture = 0x15A8;
    constexpr std::ptrdiff_t m_hLightProbeTexture = 0x15B0;
    constexpr std::ptrdiff_t m_hLightProbeDirectLightIndicesTexture = 0x15B8;
    constexpr std::ptrdiff_t m_hLightProbeDirectLightScalarsTexture = 0x15C0;
    constexpr std::ptrdiff_t m_hLightProbeDirectLightShadowsTexture = 0x15C8;
    constexpr std::ptrdiff_t m_vBoxMins = 0x15D0;
    constexpr std::ptrdiff_t m_vBoxMaxs = 0x15DC;
    constexpr std::ptrdiff_t m_bMoveable = 0x15E8;
    constexpr std::ptrdiff_t m_nHandshake = 0x15EC;
    constexpr std::ptrdiff_t m_nEnvCubeMapArrayIndex = 0x15F0;
    constexpr std::ptrdiff_t m_nPriority = 0x15F4;
    constexpr std::ptrdiff_t m_bStartDisabled = 0x15F8;
    constexpr std::ptrdiff_t m_flEdgeFadeDist = 0x15FC;
    constexpr std::ptrdiff_t m_vEdgeFadeDists = 0x1600;
    constexpr std::ptrdiff_t m_nLightProbeSizeX = 0x160C;
    constexpr std::ptrdiff_t m_nLightProbeSizeY = 0x1610;
    constexpr std::ptrdiff_t m_nLightProbeSizeZ = 0x1614;
    constexpr std::ptrdiff_t m_nLightProbeAtlasX = 0x1618;
    constexpr std::ptrdiff_t m_nLightProbeAtlasY = 0x161C;
    constexpr std::ptrdiff_t m_nLightProbeAtlasZ = 0x1620;
    constexpr std::ptrdiff_t m_bEnabled = 0x1639;
}

namespace C_EnvCubemap {
    constexpr std::ptrdiff_t m_hCubemapTexture = 0x5C0;
    constexpr std::ptrdiff_t m_bCustomCubemapTexture = 0x5C8;
    constexpr std::ptrdiff_t m_flInfluenceRadius = 0x5CC;
    constexpr std::ptrdiff_t m_vBoxProjectMins = 0x5D0;
    constexpr std::ptrdiff_t m_vBoxProjectMaxs = 0x5DC;
    constexpr std::ptrdiff_t m_bMoveable = 0x5E8;
    constexpr std::ptrdiff_t m_nHandshake = 0x5EC;
    constexpr std::ptrdiff_t m_nEnvCubeMapArrayIndex = 0x5F0;
    constexpr std::ptrdiff_t m_nPriority = 0x5F4;
    constexpr std::ptrdiff_t m_flEdgeFadeDist = 0x5F8;
    constexpr std::ptrdiff_t m_vEdgeFadeDists = 0x5FC;
    constexpr std::ptrdiff_t m_flDiffuseScale = 0x608;
    constexpr std::ptrdiff_t m_bStartDisabled = 0x60C;
    constexpr std::ptrdiff_t m_bDefaultEnvMap = 0x60D;
    constexpr std::ptrdiff_t m_bDefaultSpecEnvMap = 0x60E;
    constexpr std::ptrdiff_t m_bIndoorCubeMap = 0x60F;
    constexpr std::ptrdiff_t m_bCopyDiffuseFromDefaultCubemap = 0x610;
    constexpr std::ptrdiff_t m_bEnabled = 0x620;
}
...
namespace C_EnvLightProbeVolume {
    constexpr std::ptrdiff_t m_hLightProbeTexture = 0x1518;
    constexpr std::ptrdiff_t m_hLightProbeDirectLightIndicesTexture = 0x1520;
    constexpr std::ptrdiff_t m_hLightProbeDirectLightScalarsTexture = 0x1528;
    constexpr std::ptrdiff_t m_hLightProbeDirectLightShadowsTexture = 0x1530;
    constexpr std::ptrdiff_t m_vBoxMins = 0x1538;
    constexpr std::ptrdiff_t m_vBoxMaxs = 0x1544;
    constexpr std::ptrdiff_t m_bMoveable = 0x1550;
    constexpr std::ptrdiff_t m_nHandshake = 0x1554;
    constexpr std::ptrdiff_t m_nPriority = 0x1558;
    constexpr std::ptrdiff_t m_bStartDisabled = 0x155C;
    constexpr std::ptrdiff_t m_nLightProbeSizeX = 0x1560;
    constexpr std::ptrdiff_t m_nLightProbeSizeY = 0x1564;
    constexpr std::ptrdiff_t m_nLightProbeSizeZ = 0x1568;
    constexpr std::ptrdiff_t m_nLightProbeAtlasX = 0x156C;
    constexpr std::ptrdiff_t m_nLightProbeAtlasY = 0x1570;
    constexpr std::ptrdiff_t m_nLightProbeAtlasZ = 0x1574;
    constexpr std::ptrdiff_t m_bEnabled = 0x1581;
}
...
namespace C_Fists {
    constexpr std::ptrdiff_t m_bPlayingUninterruptableAct = 0x1A10;
    constexpr std::ptrdiff_t m_nUninterruptableActivity = 0x1A14;
}
...
namespace C_Inferno {
    ...
    constexpr std::ptrdiff_t m_firePositions = 0xD04;
    constexpr std::ptrdiff_t m_fireParentPositions = 0x1004;
...
namespace C_MolotovProjectile {
    constexpr std::ptrdiff_t m_bIsIncGrenade = 0x1100;
}
...
namespace C_PlantedC4 {
    ...
    constexpr std::ptrdiff_t m_bTriggerWarning = 0xEC0;
    constexpr std::ptrdiff_t m_bExplodeWarning = 0xEC4;
    constexpr std::ptrdiff_t m_bC4Activated = 0xEC8;
    constexpr std::ptrdiff_t m_bTenSecWarning = 0xEC9;
    constexpr std::ptrdiff_t m_flDefuseLength = 0xECC;
    constexpr std::ptrdiff_t m_flDefuseCountDown = 0xED0;
    constexpr std::ptrdiff_t m_bBombDefused = 0xED4;
    constexpr std::ptrdiff_t m_hBombDefuser = 0xED8;
    constexpr std::ptrdiff_t m_hControlPanel = 0xEDC;
    constexpr std::ptrdiff_t m_hDefuserMultimeter = 0xEE0;
    constexpr std::ptrdiff_t m_flNextRadarFlashTime = 0xEE4;
    constexpr std::ptrdiff_t m_bRadarFlash = 0xEE8;
    constexpr std::ptrdiff_t m_pBombDefuser = 0xEEC;
    constexpr std::ptrdiff_t m_fLastDefuseTime = 0xEF0;
...
namespace C_SmokeGrenadeProjectile {
    constexpr std::ptrdiff_t m_nSmokeEffectTickBegin = 0x1108;
    constexpr std::ptrdiff_t m_bDidSmokeEffect = 0x110C;
    constexpr std::ptrdiff_t m_nRandomSeed = 0x1110;
    constexpr std::ptrdiff_t m_vSmokeColor = 0x1114;
    constexpr std::ptrdiff_t m_vSmokeDetonationPos = 0x1120;
    constexpr std::ptrdiff_t m_VoxelFrameData = 0x1130;
    constexpr std::ptrdiff_t m_bSmokeVolumeDataReceived = 0x1148;
    constexpr std::ptrdiff_t m_bSmokeEffectSpawned = 0x1149;
}
...
namespace C_WeaponBaseItem {
    constexpr std::ptrdiff_t m_SequenceCompleteTimer = 0x1A10;
    constexpr std::ptrdiff_t m_bRedraw = 0x1A28;
}

namespace C_WeaponShield {
    constexpr std::ptrdiff_t m_flDisplayHealth = 0x1A30;
}

namespace C_WeaponTaser {
    constexpr std::ptrdiff_t m_fFireTime = 0x1A30;
}
